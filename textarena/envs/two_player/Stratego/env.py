...
class StrategoEnv(ta.Env):
    ...
    def _generate_player_prompt(self, player_id: int, game_state: Dict[str, Any]):
        ...
        prompt = (
            ...
            "1. **Movement Rules:**\n"
            "   - On your turn, you can move **one piece** one step to an adjacent square (up, down, left, or right).\n"
            "   - Exception: Flags and Bombs **cannot move**.\n"
            "   - Example: A piece at A1 can move to B1 (down) or A2 (right).\n"
            "\n"
            "   - **Scout Movement:**\n"
            "       - Scouts can move **any number of steps** in a straight line (horizontally or vertically).\n"
            "       - Scouts **cannot jump over any piece** (your own or your opponent's).\n"
            "       - Invalid Example: A Scout at A1 cannot move to A4 if there is another piece at A3 blocking its path.\n"
            "       - Valid Example: A Scout at A1 can move to A4 only if all squares A2 and A3 are empty.\n"
            "\n"
            "   - **Destination Rules:**\n"
            "       - You **cannot move** a piece to a square that already contains one of your own pieces.\n"
            "       - Moving onto a square occupied by an opponent's piece **initiates a battle**.\n"
            "       - Hence, you should make a move from the front line to uncover your opponent's pieces. If you are player 0, your front line begins at row D and downwards. If you are player 1, your front line begins at row G and upwards.\n"
            "\n"
            "2. **Battles:**\n"
            "   - If you move onto a square occupied by an opponent's piece, a battle occurs:\n"
            "       - The piece with the **higher rank wins** and the losing piece is removed from the board.\n"
            ...
            "       - Spies can defeat the Marshal **if the Spy attacks first**, but Spies lose to all other pieces.\n"
            "\n"
            "3. **Strategic Goals:**\n"
            "   - Protect your Flag while identifying and capturing your opponent's Flag.\n"
            "   - Use Scouts to uncover your opponent's piece positions but avoid invalid moves (e.g., jumping over pieces).\n"
            "   - Avoid moving pieces onto squares that already contain your own pieces.\n"
            "\n"
            "### How to Make a Move\n"
            "1. Identify the piece you want to move and its destination.\n"
            "2. Use the format: [A0 B0], where:\n"
            "   - A0 is the **source position** (row and column of the piece).\n"
            "   - B0 is the **destination position** (row and column where the piece will move).\n"
            "   - Example: To move a piece from A1 to A2, input [A1 A2].\n"
            "\n"
            "3. **Check Before Making a Move**:\n"
            "   - The piece you are moving is allowed to move (e.g., Flag and Bombs cannot move).\n"
            "   - The destination square is either empty or contains an opponent's piece.\n"
            "   - Scouts move in a straight line **without jumping over pieces**.\n"
            "\n"
            "### Common Mistakes to Avoid:\n"
            "1. **Jumping Over Pieces**:\n"
            "   - Scouts cannot move through or 'jump over' pieces. All squares in their path must be empty.\n"
            "\n"
            "2. **Moving Onto Your Own Pieces**:\n"
            "   - You cannot move a piece to a square that already contains one of your own pieces.\n"
            "\n"
            "3. **Invalid Coordinates**:\n"
            "   - Ensure the source and destination positions are valid and within the board boundaries.\n"
            "\n"
            "### Important Notes:\n"
            "- The board will display:\n"
            "   - The positions of **your pieces**.\n"
            "   - Known positions of your opponent's pieces (without revealing their ranks).\n"
            "- **Invalid moves will not be allowed** and will result in a warning. Plan your moves carefully.\n"
            "\n"
